...
namespace EFDbFirst.Controllers
{
    ...
    {
        private readonly JkJan23Context _context;

        public EmployeesController(JkJan23Context context)
        {
            _context = context;
        }
        ...
        {
            var jkJan23Context = _context.Employees.Include(e => e.DeptNoNavigation);
            return View(await jkJan23Context.ToListAsync());
        }
        //public IActionResult Index()
        //{
        //    return View(_context.Employees.Include(e => e.DeptNoNavigation));
        //}
        //public  IActionResult Index()
        //{
        //    var emps = _context.Employees.Include(e => e.DeptNoNavigation);
        //    return View(emps);
        //}
        //public async Task<IActionResult> Index()
        //{
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JkJan23Context.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
