...
namespace EfCodeFirstExample.Controllers
{
    ...
    {
        private readonly JuhuKhargharJan23Context _context;

        public DepartmentsController(JuhuKhargharJan23Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JuhuKhargharJan23Context.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
            if (department != null)
            {
